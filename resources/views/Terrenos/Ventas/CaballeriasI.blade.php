	...
	<body onload="inicio()">
		<div class="col-md-12" >
			<div class="card">
				...
				<br>
				<center><h3>Caballerias I</h3></center>
				<div class="row">
					<div class="col-md-2">
				...
				<div class="table-scroll">
					<table class="table-responsive">
						...
						<tbody>
							...
							<tr>
								<td style="width: 85px; height:43px; cursor:pointer;" id="133" onclick="cambiar('1','33')"></td>
							...
							<tr>
								<td style="width: 85px; height:43px;" id="132" onclick="cambiar('1','32')" ></td>
					...
					success:  function (data) { 
						...
						if(data.length==0){
							...
							if(data[0].estatus=='Disponible'){
								$('#headerModal').html('<h5 class="modal-title" id="exampleModalLongTitle">'+data[0].estatus+' - Caballerias I</h5> <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span>');
								...
								$('#headerModal').html('<h5 class="modal-title" id="exampleModalLongTitle">No Disponible - Caballerias I</h5> <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span>');
								$('#footerModal').html('');
