	...
	<body onload="inicio()">
		<div class="col-md-12" >
			<div class="card">
				...
				<br>
				<center><h3>San Bartolo IV</h3></center>
				<div class="row">
					<div class="col-md-2">
						...
						<tr>
							<td style="float: left; width: 1500px; border: 0px black solid; " >
								<table style="float: left; width:1500px; height:120px;  ">
												<tbody><tr >
														<td style="width: 250px; height:45px;cursor:pointer;"  id="115" onclick="cambiar('1','15')"></td>
														<td style="width: 100px; height:45px; border:0px black solid;" ></td>
														<td style="width: 100px; height:45px; border:0px black solid;" ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" rowspan="2" id="425" onclick="cambiar('4','25')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" rowspan="2" id="424" onclick="cambiar('4','24')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" rowspan="2" id="423" onclick="cambiar('4','23')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" rowspan="2" id="422" onclick="cambiar('4','22')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" rowspan="2" id="421" onclick="cambiar('4','21')"></td>
														...
														<td style="width: 100px; height:45px;cursor:pointer;"  id="412" onclick="cambiar('4','12')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  id="411" onclick="cambiar('4','11')"></td>
													...
													<tr>
														<td style="width: 250px; height:45px;cursor:pointer;"  id="114" onclick="cambiar('1','14')"></td>
													</tr>
													<tr >
														<td style="width: 250px; height:45px;cursor:pointer;"  id="113" onclick="cambiar('1','13')"></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
													...
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="1" id="21" onclick="cambiar('2','1')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="22" onclick="cambiar('2','2')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="1" id="23" onclick="cambiar('2','3')"></td>
														...
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" rowspan="2" id="310" onclick="cambiar('3','10')"></td>
													...
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="221" onclick="cambiar('2','21')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="24" onclick="cambiar('2','4')"></td>
														<td style="width: 100px; height:45px; border:0px black solid;" colspan="2"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="312" onclick="cambiar('3','12')"></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
													...
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="220" onclick="cambiar('2','20')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="25" onclick="cambiar('2','5')"></td>
														<td style="width: 100px; height:45px; border:0px black solid;" colspan="2"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="39" onclick="cambiar('3','9')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="313" onclick="cambiar('3','13')"></td>
													...
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="219" onclick="cambiar('2','19')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="26" onclick="cambiar('2','6')"></td>

														<td style="width: 100px; height:45px; border:0px black solid;" colspan="2"  ></td>
														
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="38" onclick="cambiar('3','8')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="314" onclick="cambiar('3','14')"></td>
													...
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="218" onclick="cambiar('2','18')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="27" onclick="cambiar('2','7')"></td>

														<td style="width: 100px; height:45px; border:0px black solid;" colspan="2"  ></td>
														
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="37" onclick="cambiar('3','7')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="315" onclick="cambiar('3','15')"></td>
													...
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="217" onclick="cambiar('2','17')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="28" onclick="cambiar('2','8')"></td>

														<td style="width: 100px; height:45px; border:0px black solid;" colspan="2"  ></td>
														
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="36" onclick="cambiar('3','6')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="316" onclick="cambiar('3','16')"></td>
													...
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="216" onclick="cambiar('2','16')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="29" onclick="cambiar('2','9')"></td>

														<td style="width: 100px; height:45px; border:0px black solid;" colspan="2"  ></td>
														
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="35" onclick="cambiar('3','5')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="317" onclick="cambiar('3','17')"></td>
													</tr>
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="215" onclick="cambiar('2','15')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="210" onclick="cambiar('2','10')"></td>
													...
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="214" onclick="cambiar('2','14')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="211" onclick="cambiar('2','11')"></td>
													...
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="213" onclick="cambiar('2','13')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="212" onclick="cambiar('2','12')"></td>

														<td style="width: 100px; height:45px; border:0px black solid;" colspan="2"  ></td>
														
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="32" onclick="cambiar('3','2')"></td>
													</tr>
													...
													<tr >
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2" id="31" onclick="cambiar('3','1')"></td>
													</tr>
