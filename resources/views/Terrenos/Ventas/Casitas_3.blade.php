					...
					<table class="" style="width: 1000px; ">
						...
						<tbody>
							<tr>
								...
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 25px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								...
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" >MZ 01</td>
							...
							<tr>
								...
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" >MZ 02</td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								...
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:35px; cursor:pointer;"  id="11" onclick="cambiar('1','1')"></td>
							...
							<tr>
								...
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; cursor:pointer;" colspan="2" id="216" onclick="cambiar('2','16')"></td>
								...
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" colspan="2" id="229" onclick="cambiar('2','29')"></td>							
							...
							<tr>
								...
								<td style="width: 50px; height:35px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 25px; height:85px; cursor:pointer;" rowspan="2" id="215" onclick="cambiar('2','15')"></td>
							...
							<tr>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 25px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ><br><br>MZ 03</td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
							...
							<tr>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 25px; height:85px; border: 0px black solid;" rowspan="2" ></td>	
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="4" colspan="2" id="325" onclick="cambiar('3','25')"></td>
							...
							<tr>
								...
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="311" onclick="cambiar('3','13')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>								
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>								
							...
							<tr>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ><br><br>Mz 04</td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" ></td>			
							...
							<tr></tr>
							<tr>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" colspan="4" id="312" onclick="cambiar('3','12')"></td>
