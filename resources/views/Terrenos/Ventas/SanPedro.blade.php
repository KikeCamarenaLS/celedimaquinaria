					...
					<table class="">
						...
						<tbody>
							...
							<tr>
								...
								<td style="width: 80px; height:85px; cursor:pointer;" rowspan="2" id="19" onclick="cambiar('1','9')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 80px; height:85px; cursor:pointer;" rowspan="2" id="31" onclick="cambiar('3','1')"></td>
								...
								<td style="width: 80px; height:85px; cursor:pointer;" rowspan="2" id="38" onclick="cambiar('3','8')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 80px; height:85px; cursor:pointer;" rowspan="2" id="51" onclick="cambiar('5','1')"></td>
								...
								<td style="width: 80px; height:85px; cursor:pointer;" rowspan="2" id="59" onclick="cambiar('5','9')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
							</tr>
							<tr></tr>
							<tr>
							...
							<tr>
								...
								<td style="width: 80px; height:85px; cursor:pointer;" rowspan="2" id="29" onclick="cambiar('2','9')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 80px; height:85px; cursor:pointer;" rowspan="2" id="41" onclick="cambiar('4','1')"></td>
								...
								<td style="width: 80px; height:85px; cursor:pointer;" rowspan="2" id="48" onclick="cambiar('4','8')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 80px; height:85px; cursor:pointer;" rowspan="2" id="61" onclick="cambiar('6','1')"></td>
								...
								<td style="width: 80px; height:85px; cursor:pointer;" rowspan="2" id="69" onclick="cambiar('6','9')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
							</tr>
...
function apartado(){
	...
	$.ajax({
			data:  {
				...
				"apartadoenganche":apartadoenganche,
			}, 
