	...
	<body onload="inicio()">
		<div class="col-md-12" >
			<div class="card">
				...
				<br>
				<center><h3>San Pablo IV</h3></center>
				<div class="row">
					<div class="col-md-2">
				...
				<div class="table-responsive">
					<table style="float: left; width: 1138px;">
						<tr>
								...
								<tr>
									...
									<td style="border: 0px black solid;">
										<table style="float: left; width:950px; height:120px;  ">
											<tbody>
												<tr >
													...
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_4" onclick="cambiar('13','4')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_5" onclick="cambiar('13','5')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_6" onclick="cambiar('13','6')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_7" onclick="cambiar('13','7')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_8" onclick="cambiar('13','8')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_9" onclick="cambiar('13','9')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_10" onclick="cambiar('13','10')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_11" onclick="cambiar('13','11')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_12" onclick="cambiar('13','12')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_13" onclick="cambiar('13','13')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_14" onclick="cambiar('13','14')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_15" onclick="cambiar('13','15')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_16" onclick="cambiar('13','16')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_17" onclick="cambiar('13','17')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_18" onclick="cambiar('13','18')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_19" onclick="cambiar('13','19')"></td>
													<td style="width: 50px; height:135px; cursor:pointer;" rowspan="2" id="13_20" onclick="cambiar('13','20')"></td>
										...
										<table style="float: left; width:950px; height:85px;  ">
											<tbody>
												<tr >
													<td style="width: 85px; height:50px; cursor:pointer;"  id="12_4" onclick="cambiar('12','4')"></td>
												...
												<tr>
													<td style="width: 85px; height:50px; cursor:pointer;"  id="12_3" onclick="cambiar('12','3')"></td>
												</tr>
												<tr>

													
													<td style="width: 85px; height:50px; cursor:pointer;"  id="12_2" onclick="cambiar('12','2')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="12_36" onclick="cambiar('12','36')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="12_35" onclick="cambiar('12','35')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="12_34" onclick="cambiar('12','34')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="12_33" onclick="cambiar('12','33')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="12_32" onclick="cambiar('12','32')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="12_31" onclick="cambiar('12','31')"></td>
												...
												<tr>
													<td style="width: 85px; height:50px; cursor:pointer;"  id="12_1" onclick="cambiar('12','1')"></td>
												</tr>
											</tbody>
										</table>
									</td>
