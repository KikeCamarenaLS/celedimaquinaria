	...
	<body onload="inicio()">
		<div class="col-md-12" >
			<div class="card">
				...
				<br>
				<center><h3>Nuevo Proyecto San Pedro</h3></center>
				<div class="row">
					<div class="col-md-2">
							...
							<td style="float: left; width: 1000px; border: 0px black solid; " >
								<table style="float: left; width:1000px; height:120px;  ">
									<tbody><tr >
										...
										<td style="width: 120px; height:45px;cursor:pointer;"  id="120" onclick="cambiar('1','20')"></td>
							...
							<td style="float: left; width: 1000px; border: 0px black solid; " >
								<table style="float: left; width:1000px; height:120px;  ">
									<tbody><tr >
										...
										<td style="width: 150px; height:45px;cursor:pointer;"  id="119" onclick="cambiar('1','19')"></td>
							...
							<td style="float: left; width: 1000px; border: 0px black solid; " >
								<table style="float: left; width:1000px; height:120px;  ">
									<tbody><tr >
										...
										<td style="width: 150px; height:45px; border: 0px black solid;"  id="" ></td>
										
									</tr>
									<tr >

										<td style="width: 150px; height:45px; border: 0px black solid;"  id="" >MZ 02</td>
							...
							<td style="float: left; width: 1000px; border: 0px black solid; " >
								<table style="float: left; width:1000px; height:120px;  ">
									<tbody><tr >
										...
										<td style="width: 100px; height:45px;cursor:pointer;"  id="224" onclick="cambiar('2','24')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="225" onclick="cambiar('2','25')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="226" onclick="cambiar('2','26')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="227" onclick="cambiar('2','27')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="228" onclick="cambiar('2','28')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="229" onclick="cambiar('2','29')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="230" onclick="cambiar('2','30')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="231" onclick="cambiar('2','31')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="232" onclick="cambiar('2','32')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="233" onclick="cambiar('2','33')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="234" onclick="cambiar('2','34')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="235" onclick="cambiar('2','35')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="236" onclick="cambiar('2','36')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="237" onclick="cambiar('2','37')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="238" onclick="cambiar('2','38')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="21" onclick="cambiar('2','1')"></td>
							...
							<td style="float: left; width: 1000px; border: 0px black solid; " >
								<table style="float: left; width:1000px; height:120px;  ">
									<tbody><tr >
										...
										<td style="width: 100px; height:45px;cursor:pointer;"  id="219" onclick="cambiar('2','19')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="218" onclick="cambiar('2','18')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="217" onclick="cambiar('2','17')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="216" onclick="cambiar('2','16')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="215" onclick="cambiar('2','15')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="214" onclick="cambiar('2','14')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="213" onclick="cambiar('2','13')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="212" onclick="cambiar('2','12')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="211" onclick="cambiar('2','11')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="210" onclick="cambiar('2','10')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="29" onclick="cambiar('2','9')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="28" onclick="cambiar('2','8')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="27" onclick="cambiar('2','7')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="26" onclick="cambiar('2','6')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="25" onclick="cambiar('2','5')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="24" onclick="cambiar('2','4')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="23" onclick="cambiar('2','3')"></td>
										<td style="width: 100px; height:45px;cursor:pointer;"  id="22" onclick="cambiar('2','2')"></td>
									</tr>
								</tbody>
							</table>
						</td>
