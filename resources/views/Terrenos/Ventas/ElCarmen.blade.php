							...
							<table style="width:1050px; ">
								<tr>
									...
									<td style="border: 0px black solid;">
										<table style="float: left; width:1150px; height:85px;  ">
											<tbody>
												<tr >
													...
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="13_16" onclick="cambiar('13','16')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="13_17" onclick="cambiar('13','17')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="13_18" onclick="cambiar('13','18')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="13_19" onclick="cambiar('13','19')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="13_20" onclick="cambiar('13','20')"></td>

													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="13_21" onclick="cambiar('13','21')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="13_22" onclick="cambiar('13','22')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="13_23" onclick="cambiar('13','23')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="13_24" onclick="cambiar('13','24')"></td>
													<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="13_25" onclick="cambiar('13','25')"></td>
