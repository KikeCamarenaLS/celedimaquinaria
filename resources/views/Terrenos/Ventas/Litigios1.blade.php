	...
	<body onload="inicio()">
		<div class="col-md-12" >
			<div class="card">
				...
				<br>
				<center><h3>Litigios 1</h3></center>
				<div class="row">
					<div class="col-md-2">
				...
				<div class="" style="overflow: scroll;">
					...
					<table class="table-responsive">
						...
						<tbody>
							...
							<tr>
								<td style="width: 85px; height:43px; cursor:pointer;" rowspan="2" id="31" onclick="cambiar('3','1')"></td>
								<td style="width: 85px; height:43px; cursor:pointer;" rowspan="2" id="32" onclick="cambiar('3','2')"></td>
						...
						<tr>
								<td style="width: 85px; height:43px; cursor:pointer;" rowspan="2" id="288" onclick="cambiar('2','88')"></td>
								<td style="width: 85px; height:43px; cursor:pointer;" rowspan="2" id="287" onclick="cambiar('2','87')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="286" onclick="cambiar('2','86')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="285" onclick="cambiar('2','85')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="284" onclick="cambiar('2','84')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="283" onclick="cambiar('2','83')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="282" onclick="cambiar('2','82')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="281" onclick="cambiar('2','81')"></td>
							...
							<tr>
								<td style="width: 85px; height:43px; cursor:pointer;" rowspan="2" id="21" onclick="cambiar('2','1')"></td>
							...
							<tr>
								...
								<td style="width: 85px; height:43px; cursor:pointer;" rowspan="2" id="12" onclick="cambiar('1','2')"></td>
							...
							<td style="border:0px black solid;">
								<table>
									<tr>
										...
										<td style="width: 85px; height:55px; border:0px black solid" rowspan="2" id="211" ></td>
									</tr>
									<tr></tr>
									<tr>
										<td style="width: 50px; height:50px; border:0px black solid;" rowspan="2" id="211" ></td>
									...
									<tr></tr>
									<tr>
										<td style="width: 50px; height:50px; border:0px black solid;" rowspan="2"></td>
										<td style="width: 85px; height:55px;cursor:pointer;" rowspan="2" id="49" onclick="cambiar('4','9')"></td>
									</tr>
									<tr></tr>
									<tr>
										<td style="width: 50px; height:50px; border:0px black solid;" rowspan="2"></td>
										<td style="width: 85px; height:55px;cursor:pointer;" rowspan="2" id="48" onclick="cambiar('4','8')"></td>
									</tr>
									<tr></tr>
									<tr>
										<td style="width: 50px; height:50px; border:0px black solid;" rowspan="2"></td>
										<td style="width: 85px; height:55px;cursor:pointer;" rowspan="2" id="47" onclick="cambiar('4','7')"></td>
									</tr>
									<tr></tr>
									<tr>
										<td style="width: 50px; height:50px; border:0px black solid;" rowspan="2"></td>
										<td style="width: 85px; height:55px;cursor:pointer;" rowspan="2" id="46" onclick="cambiar('4','6')"></td>
									</tr>
									<tr></tr>
									<tr>
										<td style="width: 50px; height:50px; border:0px black solid;" rowspan="2"></td>
										<td style="width: 85px; height:55px;cursor:pointer;" rowspan="2" id="45" onclick="cambiar('4','5')"></td>
									</tr>
									<tr></tr>
									<tr>
										<td style="width: 50px; height:50px; border:0px black solid;" rowspan="2"></td>
										<td style="width: 85px; height:55px;cursor:pointer;" rowspan="2" id="44" onclick="cambiar('4','4')"></td>
									</tr>
									<tr></tr>
									<tr>
										<td style="width: 50px; height:50px; border:0px black solid;" rowspan="2"></td>
										<td style="width: 85px; height:55px;cursor:pointer;" rowspan="2" id="43" onclick="cambiar('4','3')"></td>
									</tr>
									<tr></tr>
									<tr>
										<td style="width: 50px; height:50px; border:0px black solid;" rowspan="2"></td>
										<td style="width: 85px; height:55px;cursor:pointer;" rowspan="2" id="42" onclick="cambiar('4','2')"></td>
									</tr>
									<tr></tr><tr>
										<td style="width: 50px; height:50px; border:0px black solid;" rowspan="2"></td>
										<td style="width: 85px; height:55px;cursor:pointer;" rowspan="2" id="41" onclick="cambiar('4','1')"></td>
									</tr>
									<tr></tr>
