					...
					<table class="" style=" ">
						...
						<tbody>
							<tr>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ><br><br>Mz 07</td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ><br><br>Mz 06</td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
							...
							<tr>
								...
								<td style="width: 85px; height:40px; cursor:pointer;"  id="41" onclick="cambiar('4','1')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2"></td>
							</tr>
							<tr><td style="width: 85px; height:40px; cursor:pointer;"  id="42" onclick="cambiar('4','2')"></td></tr>
							...
							<tr>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ><br><br>MZ 05</td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2"></td>
								<td style="width: 85px; height:40px; cursor:pointer;"  id="43" onclick="cambiar('4','3')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2"></td>
							</tr>
							<tr><td style="width: 85px; height:40px; cursor:pointer;"  id="44" onclick="cambiar('4','4')"></td></tr>
							<tr>

								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="3"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="3"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="3"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="3"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="3"></td>
								...
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" colspan="3" id="514" onclick="cambiar('5','14')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="3" id="513" onclick="cambiar('5','13')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="3" id="512" onclick="cambiar('5','12')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="3" id="511" onclick="cambiar('5','11')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="3" id="510" onclick="cambiar('5','10')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="3" id="59" onclick="cambiar('5','9')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="3" id="58" onclick="cambiar('5','8')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="3" id="57" onclick="cambiar('5','7')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="3" id="56" onclick="cambiar('5','6')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="3" id="55" onclick="cambiar('5','5')"></td>
								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="3" id="54" onclick="cambiar('5','4')"></td>
								<td style="width: 50px; height:85x; cursor:pointer;"  rowspan="3" colspan="3"  rowspan="1">
									
									<table>
										<tr>
											<td style="width: 85px; height:28px; cursor:pointer;"  id="51" rowspan="1" onclick="cambiar('5','1')"></td>
										</tr>
										<tr>
											<td style="width: 85px; height:28px; cursor:pointer;"  id="52" rowspan="1" onclick="cambiar('5','2')"></td>
										</tr>
										<tr>
											<td style="width: 85px; height:28px; cursor:pointer;"  id="53" rowspan="1" onclick="cambiar('5','3')"></td>
										</tr>
									</table>
								</td>

								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="3"></td>
								<td style="width: 85px; height:40px; cursor:pointer;"  id="45" onclick="cambiar('4','5')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="3"></td>
							</tr>
							<tr>

								<td style="width: 85px; height:40px; cursor:pointer;"  id="46" onclick="cambiar('4','6')"></td>
							</tr>
							<tr></tr>
							<tr>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2"></td>
								<td style="width: 85px; height:40px; cursor:pointer;"  id="47" rowspan="2" onclick="cambiar('4','7')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2"></td>
							</tr>
							<tr>
							</tr>
							<tr>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ><br><br>Mz 11</td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ><br><br>Mz 08</td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ><br><br>Mz 03</td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
			...
			<table class="" style=" ">
						...
						<tbody>
							<tr>
								...
								<td style="width: 100px; height:85px; cursor:pointer;" rowspan="2" colspan="2"  id="81" onclick="cambiar('8','1')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 150px; height:85px; cursor:pointer;" rowspan=2 id="328" onclick="cambiar('3','28')"></td>
						...
						<tr></tr>
							<tr>
								...
								<td style="width: 50px; height:42px; cursor:pointer;" id="11_2" onclick="cambiar('11','2')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="89" onclick="cambiar('8','9')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="88" onclick="cambiar('8','8')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="87" onclick="cambiar('8','7')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="86" onclick="cambiar('8','6')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="85" onclick="cambiar('8','5')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="84" onclick="cambiar('8','4')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="83" onclick="cambiar('8','3')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="82" onclick="cambiar('8','2')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
							...
							<tr>
								<td style="width: 50px; height:42px; cursor:pointer;" id="11_3" onclick="cambiar('11','3')"></td>
							</tr>

								<tr>

								<td style="width: 50px; height:42px; cursor:pointer;" id="11_4" onclick="cambiar('11','4')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ><br><br>Mz 09</td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ><br><br>Mz 02</td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
							...
							<tr>
								<td style="width: 50px; height:42px; cursor:pointer;" id="11_5" onclick="cambiar('11','5')"></td>
							</tr>
							<tr>

								<td style="width: 50px; height:42px; cursor:pointer;" id="11_6" onclick="cambiar('11','6')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
							...
							<tr>
								<td style="width: 50px; height:42px; cursor:pointer;" id="11_7" onclick="cambiar('11','7')"></td>
							</tr>
							<tr>

								<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" id="11_8" onclick="cambiar('11','8')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2"  ></td>
								...
								<td style="width: 100px; height:85px; cursor:pointer;" rowspan="2" colspan="2" id="92" onclick="cambiar('9','2')"></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2"  ></td>
							...
							<tr>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" >MZ 10</td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								...
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ><br><br>Mz 01</td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
								<td style="width: 50px; height:85px; border: 0px black solid;" rowspan="2" rowspan="2" ></td>
	...
	<script type="text/javascript">
				...
				function inicio(){
					...
					if('{{$lote->estatus}}'=='Disponible'){
						if ({{$lote->mz}} ==13 || {{$lote->mz}} ==12 || {{$lote->mz}} ==11) {
