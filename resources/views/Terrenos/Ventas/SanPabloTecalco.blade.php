	...
	<body onload="inicio()">
		<div class="col-md-12" >
			<div class="card">
				...
				<br>
				<center><h3>San Pablo Tecalco</h3></center>
				<div class="row">
					<div class="col-md-2">
				...
				<div class="table-responsive">
					...
					<table class="" style="width: 1120px; height: 350px; border: 0px black solid;">
						...
						<tbody>
							...
							<tr>
								<td  style=" float: left; width: 85px;  height: 350px; border: 0px black solid;" rowspan="2">
							<table class="" style="width: 85px">
							...
							<tr>
								...
								<td style="border: 0px black solid;"  >Mz 05</td></tr><tr>
								<td style="width: 85px; height:50px; cursor:pointer;" id="51" onclick="cambiar('5','1')" ></td></tr><tr>
								<td style="width: 85px; height:50px; cursor:pointer;" id="52" onclick="cambiar('5','2')" ></td></tr><tr>
								<td style="width: 85px; height:50px; cursor:pointer;" id="53" onclick="cambiar('5','3')" ></td></tr><tr>
								<td style="width: 85px; height:50px; cursor:pointer;" id="54" onclick="cambiar('5','4')" ></td></tr><tr>
								<td style="width: 85px; height:50px; cursor:pointer;" id="55" onclick="cambiar('5','5')" ></td></tr><tr>
								<td style="width: 85px; height:50px; cursor:pointer;" id="56" onclick="cambiar('5','6')" ></td></tr><tr>
								<td style="width: 85px; height:50px; cursor:pointer;" id="57" onclick="cambiar('5','7')" ></td></tr><tr>
				...
				<td style=" float: left;  height: 350px; border: 0px black solid;" rowspan="2">
					<table class="" style="width: 85px; height: 100% border: 0px black solid;">


						<tbody>
							
							<tr>
								<td  style=" float: left; width: 85px; border: 0px black solid;"></td>
							</tr>
						</tbody>
					</table>
				...
				<td style=" float: left;  height:180px;  border: 0px black solid;">
					<table style="float: left; width:750px; height:180px;  border: 0px black solid; ">
						<tbody>
							<tr><td style="border: 0px black solid;">Mz.03</td></tr>
								<tr >
					...
					<tr style="border: 0px black solid;">
								<td  style="  border: 0px black solid;"><br><br>Mz.02</td>
							</tr>
					<tr >
					...
					<table style=" width:1000px; height:85px;  "><br><br><font size="1">
						...
						<tbody>
								<tr >
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="117" onclick="cambiar('1','17')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="116" onclick="cambiar('1','16')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="115" onclick="cambiar('1','15')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="114" onclick="cambiar('1','14')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="113" onclick="cambiar('1','13')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="112" onclick="cambiar('1','12')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="111" onclick="cambiar('1','11')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="110" onclick="cambiar('1','10')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="19" onclick="cambiar('1','9')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="18" onclick="cambiar('1','8')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="17" onclick="cambiar('1','7')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="16" onclick="cambiar('1','6')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="15" onclick="cambiar('1','5')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="14" onclick="cambiar('1','4')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="13" onclick="cambiar('1','3')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="12" onclick="cambiar('1','2')"></td>
								<td style="width: 45px; height:85px; cursor:pointer;" rowspan="2" id="11" onclick="cambiar('1','1')"></td>
							</tr>
							</tbody>
							<tr></tr>
							<tr></tr>
