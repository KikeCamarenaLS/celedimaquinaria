	...
	<body onload="inicio()">
		<div class="col-md-12" >
			<div class="card">
				...
				<br>
				<center><h3>San Pablo XII</h3></center>
				<div class="row">
					<div class="col-md-2">
								...
								<table style="float: left; width:1500px; height:120px;  ">
												<tbody><tr >
													...
													<tr >
														...
														<td style="width: 100px; height:45px;cursor:pointer;"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 200px; height:45px;cursor:pointer;" colspan="2" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
													...
													<tr >
														...
														<td style="width: 100px; height:25px;cursor:pointer;" colspan="2"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:15px;cursor:pointer;" rowspan="3" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:15px;cursor:pointer;" rowspan="3" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:15px;cursor:pointer;" rowspan="3" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:15px;cursor:pointer;" rowspan="3" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:15px;cursor:pointer;" rowspan="3" id="13_3" onclick="cambiar('13','3')"></td>
														...
														<td style="width: 100px; height:15px;cursor:pointer;" rowspan="3" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:15px;cursor:pointer;" rowspan="3" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:15px;cursor:pointer;" rowspan="2" colspan="3" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														...
														<td style="width: 100px; height:45px; border:0px black solid;"  ></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  id="13_3" onclick="cambiar('13','3')" colspan="2"></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  id="13_3" onclick="cambiar('13','3')" colspan="2"></td>
													...
													<tr>
														...
														<td style="width: 100px; height:45px; border:0px black solid;" rowspan="2" ></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  rowspan="2" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  rowspan="2" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px; border:0px black solid;" rowspan="2" ></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  rowspan="2" id="13_3" onclick="cambiar('13','3')"></td>
														...
														<td style="width: 100px; height:45px;cursor:pointer;"  rowspan="2" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  rowspan="2" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:25px; border:0px black solid;" colspan="1" rowspan="2" ></td>
														<td style="width: 100px; height:25px;cursor:pointer;"  colspan="2"   id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:25px; border:0px black solid;" colspan="19" ></td>
														<td style="width: 100px; height:25px;cursor:pointer;"  colspan="2"   id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:25px;cursor:pointer;"  colspan="2"   id="13_3" onclick="cambiar('13','3')"></td>

														<td style="width: 100px; height:25px; border:0px black solid;" colspan="1" ></td>

														<td style="width: 100px; height:25px;cursor:pointer;"  id="13_3" onclick="cambiar('13','3')"></td>
													...
													<tr>
														...
														<td style="width: 100px; height:25px;cursor:pointer;"   id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:25px;cursor:pointer;"   id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:25px; border:0px black solid;" colspan="11" ></td>
														<td style="width: 100px; height:25px;cursor:pointer;" colspan="2"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:25px;cursor:pointer;" colspan="2"  id="13_3" onclick="cambiar('13','3')"></td>
															<td style="width: 100px; height:25px; border:0px black solid;" colspan="1" ></td>
													...
													<tr>
														...
														<td style="width: 100px; height:25px;cursor:pointer;" colspan="1"  id="13_3" onclick="cambiar('13','3')"></td>
													
														<td style="width: 100px; height:25px; border:0px black solid;" colspan="33" ></td>
														<td style="width: 100px; height:25px;cursor:pointer;" colspan="1" rowspan="2" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:25px;cursor:pointer;" colspan="1" rowspan="2" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:25px;cursor:pointer;" colspan="1" rowspan="2" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:25px;cursor:pointer;" colspan="1" rowspan="2" id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:25px;cursor:pointer;" colspan="1" rowspan="2" id="13_3" onclick="cambiar('13','3')"></td>
													...
													<tr>
														...
														<td style="width: 100px; height:25px; border:0px black solid;" colspan="37" ></td>
													...
													<tr>
														...
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="1"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="1"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="1"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="1"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="1"  id="13_3" onclick="cambiar('13','3')"></td>
														...
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="1"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;" colspan="2"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px; border:0px black solid;" colspan="1" ></td>
													...
													<tr>
														<td style="width: 100px; height:45px; border:0px black solid;" colspan="31" ></td>
													...
													<tr>
														<td style="width: 100px; height:25px; border:0px black solid;" colspan="31" ></td>
													...
													<tr>
														<td style="width: 100px; height:25px; border:0px black solid;" colspan="32" ></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  id="13_3" onclick="cambiar('13','3')"></td>
														<td style="width: 100px; height:45px;cursor:pointer;"  id="13_3" onclick="cambiar('13','3')"></td>
