	...
	<body onload="inicio()">
		<div class="col-md-12" >
			<div class="card">
				...
				<br>
				<center><h3>San Pablo VII</h3></center>
				<div class="row">
					<div class="col-md-2">
				...
				<div class="table-responsive">
					<table style="float: left; width: 1000px;">
						<tr>
								...
								<table style="float: left; width:1000px; height:120px;  ">
									<tbody>
										...
										<tr >
											...
											<td style="width: 50px; height:85px; border:0px black solid;"  ></td>
											<td style="width: 50px; height:85px; border:0px black solid;"  >Mz 04</td>
										...
										<tr >
											...
											<td style="width: 50px; height:85px; border:0px black solid;"  ></td>
											<td style="width: 50px; height:85px; border:0px black solid;"  ></td>
											<td style="width: 50px; height:85px; border:0px black solid;"  ><br><br>Mz 02</td>
											<td style="width: 50px; height:85px; border:0px black solid;"  ></td>
											<td style="width: 50px; height:85px; border:0px black solid;"  ></td>
											<td style="width: 50px; height:85px; border:0px black solid;"  ></td>
											<td style="width: 50px; height:85px; border:0px black solid;"  ></td>
										...
										<tr >
											...
											<td style="width: 50px; height:85px; cursor:pointer;" rowspan="2" colspan="2" id="233" onclick="cambiar('2','33')"></td>
											<td style="width: 50px; height:85px; border:0px black solid;"  ></td>
										...
										<tr >
											...
											<td style="width: 50px; height:60px; cursor:pointer;" rowspan="2" id="115" onclick="cambiar('1','15')"></td>
											<td style="width: 50px; height:60px; border:0px black solid;"  ></td>
										</tr>	
										<tr></tr>
										<tr >
											
											<td style="width: 50px; height:60px; cursor:pointer;" rowspan="2" id="114" onclick="cambiar('1','14')"></td>
											<td style="width: 50px; height:60px; border:0px black solid;"  >Mz 01</td>
										</tr>
										<tr></tr>
										<tr >
