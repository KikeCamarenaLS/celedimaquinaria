...
<head>
	...
	<div class="contenido" style="margin-top: 40px">
		...
		<div id="vale">
			...
			<p align=left style="margin-right: 0in; margin-top: 0px;"><font face="times new roman, serif" style="font-color: #666666 !important;"><font size=3><font face="arial narrow, sans-serif"><font size=2 style="font-size: 8pt"><span lang="en-us"><b style="color: #666666 !important;"><span style="color: #666666 !important;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>EJERCICIO  </strong> </span></b></span></font></font></font></font></p>
			...
			<p>
				...
				<tr>
					<td align="center" style="font-size: 10px; color: #646464;" width="50%">PERCEPCIONES</td>
			...
			<p>
				<table width="100%" border="1" style="border:0px solid #646464; border-collapse: collapse; margin:-15px;" >
					<thead>
						<tr >
							<td  align="center" width="12%" style="border-top:0px solid black;" class="tablaPrincipal" >
								USUARIO:
							</td>
							<td align="center" width="18%" style="border-top:0px solid black;" class="tablaPrincipal" >
							...
							<td align="right" width="40%" style="border-top:0px solid black;" class="tablaPrincipal" >
								TOTAL $
							</td>
							<td  align="center" width="10%" style="border-top:0px solid black;" class="tablaPrincipal" >
					...
					<thead>
						<tr >
							...
							<td align="left" width="16%" style="border-top:0px solid black;" class="tablaPrincipal">
								<Strong>IMPORTE NETO A PAGAR $</Strong>
							</td>
							<td align="center" width="10%" style="border-top:0px solid black;" class="tablaPrincipal" >
