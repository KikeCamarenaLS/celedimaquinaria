				...
				<div class="card-body">
					...
					<div  style="width:100%;">
						<div class="form-group row " >
							<div class="col-md-6 " id="comboEquipo"></div>
							<div class="col-md-6 " id="comboMarca"></div>
							<div class="col-md-4 " id="comboModelo"></div>
						</div>
						<div id="inventarioVue" style="display: none;">
							<div  id="app" >
								<inventario-resguardos></inventario-resguardos>
								<!-- Etiqueta VUE -->
			...
			<script type="text/javascript">
				...
				function footerModal(ID_Inventario){
					$.get("{{url('/detalles/observaciones/caracteristicas')}}"+ID_Inventario, function(data){
						...
						html='';
						html+='<label><b>Caracteristícas :</b></label> <label name="firstname"> </label></div> <div class="col-md-12">';
				...
				function llenarCaracteristicas(){
					...
					if(Categoria=="Selecciona una Categoria"){
						...
						$.get("{{url('/buscar_resguardo/CaracteristicasEquipo')}}/"+Bienes+"/"+Categoria+"/"+No_Empleadoo, function(data){
							console.log(data);
							var html='';
							if(data.length==0){
				...
				function pintarTablaListaEquipo(id_equipo,equipo,marca,modelo,i){
					...
					'<td class="info " id="MarcaListaEquipo">'+MarcaArreglo[i]+'</td>'+
					'<td class="info " id="ModeloListaEquipo">'+ModeloArreglo[i]+'</td>';
				...
				function guardar(){
					...
					this.mensaje('success','Resguardo asignado correctamente al ID del Empleado '+ID_Personal_Global+'');
					ID_Personal_Global="";
					$('#tablaEquipos').html("");
