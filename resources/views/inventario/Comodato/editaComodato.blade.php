	...
	<div class="col-md-12"> <!-- Inicio de columna de row -->
		<div class="card"><!-- inicio de cuerpo card -->
			...
			<div class="card-header">
				<div class="card-title">Edita Comodato</div>
						...
						<table class="table" id="list_user">
							<thead>
								<tr>
									...
									<th class="bg-primary sorting" style="color:#ffffff; width: 12%;"><center>Serie</center></th>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
      	<div class="row">
			...
			<div class="col-md-3">
						...
						<input type="text" class="form-control " id="idem" name="idem"  onkeyup ="Cargartabla2()">
					</div>
					<div class="col-md-6">
						<label>Nombre  </label>
					...
					<div class="col-md-4">
						<label>Área</label>
						<select required="" type="text" class="form-control" id="Are" name="Are"  >
							<option>Sin Área</option>
							<option>Agrupamientos</option>
							<option>Calidad</option>
							<option>Comandante de Región I</option>
       ...
       <input type="hidden" id="ID_inventariohiden">

      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
        <button type="button" class="btn btn-primary" onclick="cambiarEstatus()">Actualizar</button>
      </div>
    </div>
  </div>
</div>
	...
	<script type="text/javascript">
		...
		var encontrado=0;
		function Cargartabla(ID_EMPLEADOi){
			var textoBuscar=ID_EMPLEADOi;
		...
		function Cargartabla2(){
			var textoBuscar=document.getElementById('idem').value;
			if(textoBuscar.length==7){
				...
				success:  function (response) { 
					...
					if(response.length>0){
							...
							var con=i+1;
								...
								html+="<td>"+response[i].serie+"</td>";
								seriecomilla='"'+response[i].serie+'"';
								Areasita='"'+response[i].Area+'"';
								ID_EMPLEADOi='"'+response[i].ID_EMPLEADO+'"';
								comodatoArrendado='"'+response[i].id_inventario_comodato+'"';
								...
								html+="<td><input type='submit' class='btn btn-success' data-toggle='modal' data-target='#exampleModal' value='Editar' onclick='mostrarmodal("+response[i].ID_inventario+","+seriecomilla+","+Areasita+","+ID_EMPLEADOi+","+comodatoArrendado+")'></td>";
		...
		function mostrarmodal(id,serie,Areasita,ID_EMPLEADOi,comodatoArrendado){
			$('#serie').val(serie);
			$('#ID_inventariohiden').val(id);
			Cargartabla(ID_EMPLEADOi);
			
			 $("#Are").val(Areasita );
			  $("#comodatoArrendado").val(comodatoArrendado );
			  console.log(comodatoArrendado);
		...
		function cambiarEstatus(){
			...
			$.ajax({
				data:  {
				"id":$('#ID_inventariohiden').val(),
				"serie":$('#serie').val(),
				"idem":$('#idem').val(),
				"Are":$('#Are').val(),
				"comodatoArrendado":$('#comodatoArrendado').val(),
			}, 
				url:   "{{url('cambiarserie/comodato')}}",
				type:  'get',
				success:  function (response) { 
					console.log(response);
					mensaje('success','La serie fue modificada!!');
