			...
			<div class="modal-dialog modal-lg" role="document">
				...
				<div class="modal-content">
					...
					<div class="modal-footer justify-content-center flex-column flex-md-row">
						...
						data-dismiss="modal" v-on:click="ModificarInventario(IdInventario, Modal_Bien , Modal_Categoria, Modal_No_inventario, Modal_Marca, Modal_Modelo, Modal_Serie, Modal_Foto, Modal_Estatus, Modal_Observaciones)">Editar</button>
